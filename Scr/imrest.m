...
% this function performs the linear and non-linear spatial filtering for image restoration
% F = IMREST(G,TYPE,M,N,PARAMETER) performs spatial filtering of image G, using a TYPE filter of M by N. 
% Valid calls to IMREST are as follows:
%
...
% F = IMREST(G,'chmean',M,N,Q)      Contraharmonic mean filtering of order Q. The default is Q = 1.5.
...
%
% The default values when only G and TYPE are input are M=N=3, Q = 1.5,and D = 2.
